...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <a href="/dashboard/post/create" class="btn btn-primary mb-3 px-4">Buat Post</a>
                        ...
                        <tr>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="/dashboard/post/dalete/{{$post->id"><i class="fas fa-trash-alt pr-2 text-danger"></i>Dalete</a>
                                </div>
                            </div>
                            </td>
                        </tr>
